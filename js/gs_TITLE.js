_APP.game.gamestates["gs_TITLE"] = {
    ...
    init: function(){
        ...
        if(test == "title"){
            _GFX.layerObjs.updateOne(UnoLetter, { letter: "u", x:2 , y: 1, layerObjKey: `letter_uno_u`, layerKey: "BG1", xyByGrid: true, });
            _GFX.layerObjs.updateOne(UnoLetter, { letter: "n", x:10, y: 3, layerObjKey: `letter_uno_n`, layerKey: "BG1", xyByGrid: true, });
            _GFX.layerObjs.updateOne(UnoLetter, { letter: "o", x:18, y: 5, layerObjKey: `letter_uno_o`, layerKey: "BG1", xyByGrid: true, });
            ...
            _GFX.layerObjs.updateOne(PrintText, { text: "PLAY GAME (NETPLAY)", x:6, y: y+=2, layerObjKey: `text2`, layerKey: "TX1", xyByGrid: true, settings: { colorData: [ [[255,255,255,255],[64,64,64,255] ]] } } );
            ...
            _GFX.layerObjs.updateOne(Cursor1, { x:cursorPosition.x, y:cursorPosition.y, layerObjKey: `menuCursor1`, layerKey: "BG1", xyByGrid: true, settings:{rotation: 90} } );
            
            // Uno small cards (left side)
            y = -3;
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_1`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_2`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_3`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_4`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_5`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_6`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:0, y:y+=4, layerObjKey: `card_l_7`, layerKey: "BG2", xyByGrid: true } );
            
            // Uno small cards (right side)
            y = -4;
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_1`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_2`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_3`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_4`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_5`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_6`, layerKey: "BG2", xyByGrid: true } );
            _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:26, y:y+=4, layerObjKey: `card_r_7`, layerKey: "BG2", xyByGrid: true } );
        }
            ...
            for(let c=0; c<colors.length; c+=1){
                ...
                if(color=="CARD_BACK"){
                    ...
                    _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_BACK", x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                    x+=2;
                    if(x >= 26){ x=0; y+=3; }
                }
                else if(color=="CARD_BLACK"){
                    layerKey = `sm_${color}_CARD_WILD`;
                    _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_WILD"      , x:x, y:y, layerObjKey: layerKey      , layerKey: "BG1", xyByGrid: true } );
                    x+=2;
                    if(x >= 26){ x=0; y+=3; }

                    layerKey = `sm_${color}_CARD_WILD_DRAW4`;
                    _GFX.layerObjs.updateOne(Card, { size: "sm", color:"CARD_BLACK", value: "CARD_WILD_DRAW4", x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                    x+=2;
                    if(x >= 26){ x=0; y+=3; }
                }
                else{
                    for(let v=0; v<values.length; v+=1){
                        ...
                        _GFX.layerObjs.updateOne(Card, { size: "sm", color:color, value: value, x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                        x+=2;
                        if(x >= 26){ x=0; y+=3; }
                    }
                }
            ...
            for(let c=0; c<colors.length; c+=1){
                ...
                if(color=="CARD_BACK"){
                    ...
                    _GFX.layerObjs.updateOne(Card, { size: "lg", color:"CARD_BLACK", value: "CARD_BACK", x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                    x+=3;
                    if(x >= 26){ x=0; y+=4; }
                }
                else if(color=="CARD_BLACK"){
                    layerKey = `lg_${color}_CARD_WILD`;
                    _GFX.layerObjs.updateOne(Card, { size: "lg", color:"CARD_BLACK", value: "CARD_WILD"      , x:x, y:y, layerObjKey: layerKey      , layerKey: "BG1", xyByGrid: true } );
                    x+=3;
                    if(x >= 26){ x=0; y+=4; }

                    layerKey = `lg_${color}_CARD_WILD_DRAW4`;
                    _GFX.layerObjs.updateOne(Card, { size: "lg", color:"CARD_BLACK", value: "CARD_WILD_DRAW4", x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                    x+=3;
                    if(x >= 26){ x=0; y+=4; }
                }
                else{
                    for(let v=0; v<values.length; v+=1){
                        ...
                        _GFX.layerObjs.updateOne(Card, { size: "lg", color:color, value: value, x:x, y:y, layerObjKey: layerKey, layerKey: "BG1", xyByGrid: true } );
                        x+=3;
                        if(x >= 26){ x=0; y+=4; }
                    }
                }
